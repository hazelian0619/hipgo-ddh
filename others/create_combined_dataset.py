...
def create_combined_dataset(original_dir, expand_dir, target_dir, num_samples=200):
    """
    创建合并数据集，确保图片不重复
    """
    # 创建目标目录
    ...
    for idx, (source_type, source_file) in enumerate(selected_images, 1):
        ...
        target_path = os.path.join(target_dir, f"validation_{idx:03d}.jpg")
        ...
        if source_type == 'original':
            ...
            json_target = f"validation_{idx:03d}.json"
...
if __name__ == "__main__":
    ...
    create_combined_dataset(original_dir, expand_dir, target_dir) 